...
pub struct Dict {
    ...
    pub tui_tab_full_year: &'static str,
    pub tui_sidebar_month: &'static str,
    pub tui_sidebar_settings: &'static str,
    pub tui_sidebar_settings_month: &'static str,
    ...
    // Full-Year global minimum / target sliders + per-month override sliders.
    pub tui_slider_min_workday: &'static str,
    pub tui_slider_min_parallel: &'static str,
    pub tui_slider_min_monthly_profit: &'static str,
    pub tui_slider_target_yearly: &'static str,
    pub tui_slider_month_workday: &'static str,
    pub tui_slider_month_parallel: &'static str,
    pub tui_slider_month_profit: &'static str,
    pub tui_slider_month_fix_costs: &'static str,
    pub tui_period_full_year: &'static str,
...
define_dict! {
    ...
    tui_tab_full_year: ["Full Year", "Año completo", "全年", "Gesamtes Jahr", "Весь год", "Année complète"],
    tui_sidebar_month: ["Month", "Mes", "月份", "Monat", "Месяц", "Mois"],
    tui_sidebar_settings: ["Global settings", "Ajustes globales", "全局设置", "Globale Einstellungen", "Глобальные настройки", "Paramètres globaux"],
    tui_sidebar_settings_month: ["{0} specific settings", "Ajustes específicos de {0}", "{0} 具体设置", "{0} spezifische Einstellungen", "Настройки для {0}", "Paramètres spécifiques de {0}"],
    ...
    // Full-Year global minimum / target sliders + per-month override sliders.
    tui_slider_min_workday: ["min. workday hours", "mín. horas de jornada", "最小工作日小时", "Min. Arbeitsstunden", "мин. часы рабочего дня", "min. heures de travail"],
    tui_slider_min_parallel: ["min. parallel products", "mín. productos en paralelo", "最小并行产品", "Min. Parallelprodukte", "мин. параллельные продукты", "min. produits parallèles"],
    tui_slider_min_monthly_profit: ["min. monthly net profit", "mín. beneficio neto mensual", "最小月度净利润", "Min. monatlicher Nettogewinn", "мин. месячная чистая прибыль", "min. profit net mensuel"],
    tui_slider_target_yearly: ["target yearly net profit", "objetivo anual de beneficio neto", "年度净利润目标", "Ziel-Jahresnettogewinn", "цель годовой чистой прибыли", "objectif annuel de profit net"],
    tui_slider_month_workday: ["workday hours", "horas de jornada", "工作日小时", "Arbeitsstunden", "часы рабочего дня", "heures de travail"],
    tui_slider_month_parallel: ["parallel products", "productos en paralelo", "并行产品", "Parallelprodukte", "параллельные продукты", "produits parallèles"],
    tui_slider_month_profit: ["net profit target", "objetivo beneficio neto", "净利润目标", "Nettogewinnziel", "цель чистой прибыли", "objectif profit net"],
    tui_slider_month_fix_costs: ["fix costs", "costes fijos", "固定成本", "Fixkosten", "фикс. затраты", "coûts fixes"],
    tui_period_full_year: ["Full Year", "Año completo", "全年", "Gesamtes Jahr", "Весь год", "Année complète"],
    ...
    tui_label_min: ["minutes", "minutos", "分钟", "Minuten", "минуты", "minutes"],
    ...
    tui_footer: [
        "Tab sub-tab   Shift+Tab/o sidebar   [ / ] switch period   \u{2191}/\u{2193} scroll/navigate   \u{2190}/\u{2192} adjust   Space lock   Ctrl+E export   Ctrl+H help   q quit",
        "Tab sub-pestaña   Shift+Tab/o lateral   [ / ] cambiar periodo   \u{2191}/\u{2193} desplazar/navegar   \u{2190}/\u{2192} ajustar   Espacio bloquear   Ctrl+E exportar   Ctrl+H ayuda   q salir",
        "Tab 子标签   Shift+Tab/o 侧栏   [ / ] 切换周期   \u{2191}/\u{2193} 滚动/导航   \u{2190}/\u{2192} 调整   空格 锁定   Ctrl+E 导出   Ctrl+H 帮助   q 退出",
        "Tab Unter-Tab   Shift+Tab/o Sidebar   [ / ] Zeitraum wechseln   \u{2191}/\u{2193} scrollen/navigieren   \u{2190}/\u{2192} anpassen   Leertaste sperren   Ctrl+E Export   Ctrl+H Hilfe   q Beenden",
        "Tab под-вкладка   Shift+Tab/o боковая   [ / ] сменить период   \u{2191}/\u{2193} прокрутка/навигация   \u{2190}/\u{2192} настроить   Пробел блок.   Ctrl+E экспорт   Ctrl+H справка   q выход",
        "Tab sous-onglet   Shift+Tab/o latéral   [ / ] changer période   \u{2191}/\u{2193} défiler/naviguer   \u{2190}/\u{2192} ajuster   Espace verrouiller   Ctrl+E exporter   Ctrl+H aide   q quitter",
    ],
    tui_footer_status: [
        "{0}   |   Tab sub-tab   Shift+Tab/o sidebar   [ / ] switch period   \u{2191}/\u{2193} scroll/navigate   \u{2190}/\u{2192} adjust   Space lock   Ctrl+E export   Ctrl+H help   q quit",
        "{0}   |   Tab sub-pestaña   Shift+Tab/o lateral   [ / ] cambiar periodo   \u{2191}/\u{2193} desplazar/navegar   \u{2190}/\u{2192} ajustar   Espacio bloquear   Ctrl+E exportar   Ctrl+H ayuda   q salir",
        "{0}   |   Tab 子标签   Shift+Tab/o 侧栏   [ / ] 切换周期   \u{2191}/\u{2193} 滚动/导航   \u{2190}/\u{2192} 调整   空格 锁定   Ctrl+E 导出   Ctrl+H 帮助   q 退出",
        "{0}   |   Tab Unter-Tab   Shift+Tab/o Sidebar   [ / ] Zeitraum wechseln   \u{2191}/\u{2193} scrollen/navigieren   \u{2190}/\u{2192} anpassen   Leertaste sperren   Ctrl+E Export   Ctrl+H Hilfe   q Beenden",
        "{0}   |   Tab под-вкладка   Shift+Tab/o боковая   [ / ] сменить период   \u{2191}/\u{2193} прокрутка/навигация   \u{2190}/\u{2192} настроить   Пробел блок.   Ctrl+E экспорт   Ctrl+H справка   q выход",
        "{0}   |   Tab sous-onglet   Shift+Tab/o latéral   [ / ] changer période   \u{2191}/\u{2193} défiler/naviguer   \u{2190}/\u{2192} ajuster   Espace verrouiller   Ctrl+E exporter   Ctrl+H aide   q quitter",
    ],
    ...
    tui_help_text: [
        "## Product definition (.txt files)\nEach product is a plain-text file in the business folder. The first line defines the product; every following line starting with \"- \" is a cost.\n\n  + <name> : <sale_price> <currency> : <production_time> <unit>\n    - <cost_price> <currency> <description>\n    - <cost_price> <currency> <description>\n\n  Example:\n  + Beer : 2.7 USD : 0.2 mins\n    - 0.27 USD labor\n    - 0.32 USD beer\n    - 0.10 USD cleaning\n\n  - Currency: any 3-letter ISO 4217 code (USD, EUR, GBP, JPY, MXN, CNY, ...).\n  - Production-time units: \"mins\" or \"hours\".\n  - Products whose net profit (price - total cost) is zero or negative are skipped.\n  - Files matching *.simulation_results.txt and simulation_state.txt are ignored by the loader.\n\n## Monthly & yearly net-profit goals\nThe simulator targets a NET-PROFIT goal (income minus costs), not revenue. The top-level period tabs select Full Year or a single month (Jan..Dec); the sidebar changes accordingly:\n\n  - Full Year: four global sliders — min. workday hours (default 8), min. parallel products (default 1), min. monthly net profit (default 500) and target yearly net profit (default 500, a reference shown next to the 12 x monthly sum).\n  - A month: four override sliders — workday hours, parallel products, net profit and fix costs for that month. Each override must be at least its global minimum and replaces the minimum for that month only.\n\nEach month, that month's net-profit goal is split across products by their sales-% share, giving a required sales count per product:\n\n  required_sales = ceil(share * (monthly_goal + fix_costs) / net_profit_per_unit)\n\nThe fix costs slider adds a monthly fixed cost (currency units) subtracted from the month's net profit, so the products must cover both the goal and the fixed burden. The yearly total is the SUM of the 12 monthly results, so the target yearly net profit is only a reference.\n\n## Parallel products / services\nThe \"parallel\" slider is how many products can be produced or services delivered at the same time. Together with the workday hours it defines the monthly production CAPACITY in minutes:\n\n  capacity_minutes = workday_hours * 22 workdays * 60 * parallel\n\nIf the required production minutes exceed capacity, sales are scaled down to fit (the goal cannot be fully met that month). Workday hours and parallel products are set per month (each at least its global minimum); a month's parallel slider max is recomputed from that month's load on every change.\n\n## Workday hours\nHow many hours per day the business operates (1..24). It feeds the capacity formula above and the \"workdays\" figure shown in the results:\n\n  workdays = required_hours / (workday_hours * parallel)\n\nThe Full Year \"min. workday hours\" sets the floor; each month overrides it (at least the minimum). The Graph always shows the full year. Above each month's bars a green ✔ marks months whose achieved net profit meets that month's goal; a red ✖ marks months that fall short. A downward arrow above the selected month's bars highlights it (no arrow for Full Year).\n\n## Monthly / yearly sales distribution %\nEach month's goal is divided between products using percentages. Every month column always sums to exactly 100%. Percentage sliders move in steps of 0.1% (the value is shown with one decimal, e.g. 50.0%).\n\n  - A Month period: each product shows a monthly-% slider for that month. Editing it sets that product's % and redistributes the remainder EQUALLY across all other non-locked products in that month.\n  - Full Year period: each product shows a yearly-% slider (the mean of its 12 monthly values). Editing it propagates the target to every month where the product isn't month-locked, redistributing within each month.\n\nThe chart draws 12 separate monthly columns, so the mix can vary per month (seasonal demand). The yearly total is the sum of the 12 months.\n\n## Locks\nLocks freeze a product's percentage so it is excluded from redistribution.\n\n  - Yearly lock (Full Year period, Space on a yearly slider): freezes the product in ALL 12 months. Month checkboxes render checked and greyed out.\n  - Month lock (a Month period, Space on a monthly slider): freezes the product only for that month (disabled if the product is yearly-locked).\n\nLocked products keep their fixed share of the 100% pie; the remaining percentage is split among the unlocked products.\n\n## Exports & state\nPress Ctrl+E to export the current simulation:\n\n  - One <product>.simulation_results.txt per product (stats + 12 monthly rows + annual row + workday/parallel).\n  - A totals.simulation_results.txt aggregating all products.\n  - A simulation_state.txt file (plain, editable text) saving percentages, locks and settings.\n\nReopening the app restores the saved distribution. If products were added or removed since the save, each month's percentages are re-normalized to sum to 100%.\n\n## Sidebar totals\nThe bottom of the sidebar shows achievable (capacity-capped) totals, which always match the chart. The layout depends on the selected period:\n\n  - Full Year: left column = Yearly totals; right column = Yearly ref.\n  - A month: left column = Monthly totals (+ a goal-achievement line); right column = Yearly totals + Yearly ref.\n\nEach period block (Monthly / Yearly) shows four rows:\n  - sales — total units sold (after capacity capping).\n  - minutes — achieved production minutes (capped units x product production time).\n  - hours — minutes / 60.\n  - workdays — hours / (workday_hours x parallel). The annual workdays sum each month using its own workday-hours / parallel override.\n\nFor a selected month, an extra line at the end of the Monthly block shows whether the month's net-profit goal was reached: a green check if the month's achieved net profit >= the month's goal, a red cross otherwise, followed by the goal value.\n\nThe Yearly ref block compares the sum of the 12 monthly net-profit goals (each including that month's fix costs) against the target yearly net profit:\n  - 12x mo — sum of the 12 monthly net-profit goals (each month's override, else the global min. monthly net profit) plus each month's fix costs.\n  - check / cross + goal — green check if that sum meets the target yearly net profit, red cross otherwise, followed by the target value. The target yearly net profit is only a reference; the yearly total is the sum of the 12 monthly results.\n\n## Keys\n  Tab          switch Products <-> Graph sub-tab\n  Shift+Tab    toggle sidebar <-> main area (o also works on raw TTYs where Shift+Tab = Tab)\n  [ / ]        move the top-level period selection (Full Year, Jan..Dec)\n  Up / Down    scroll main area or navigate sidebar sliders\n  Left / Right adjust the focused slider\n  Space        toggle the lock of the focused product slider\n  Ctrl+E       export simulation + save state\n  Ctrl+H       open / close this help\n  q / Esc      quit (close help if it is open)",
        "## Definición de producto (archivos .txt)\nCada producto es un archivo de texto plano en la carpeta del negocio. La primera línea define el producto; cada línea siguiente que empiece por \"- \" es un coste.\n\n  + <nombre> : <precio_venta> <moneda> : <tiempo_producción> <unidad>\n    - <precio_coste> <moneda> <descripción>\n    - <precio_coste> <moneda> <descripción>\n\n  Ejemplo:\n  + Beer : 2.7 USD : 0.2 mins\n    - 0.27 USD labor\n    - 0.32 USD beer\n    - 0.10 USD cleaning\n\n  - Moneda: cualquier código ISO 4217 de 3 letras (USD, EUR, GBP, JPY, MXN, CNY, ...).\n  - Unidades de tiempo de producción: \"mins\" u \"hours\".\n  - Los productos cuyo beneficio neto (precio - coste total) sea cero o negativo se omiten.\n  - Los archivos *.simulation_results.txt y simulation_state.txt los ignora el cargador.\n\n## Objetivos de beneficio neto mensual y anual\nEl simulador persigue un objetivo de BENEFICIO NETO (ingresos menos costes), no de ingresos. Las pestañas de período de nivel superior seleccionan Año completo o un solo mes (Ene..Dic); la barra lateral cambia en consecuencia:\n\n  - Año completo: cuatro deslizadores globales — mín. horas de jornada (por defecto 8), mín. productos en paralelo (por defecto 1), mín. beneficio neto mensual (por defecto 500) y objetivo anual de beneficio neto (por defecto 500, una referencia mostrada junto a la suma de 12 x mensual).\n  - Un mes: cuatro deslizadores de anulación — horas de jornada, productos en paralelo, beneficio neto y costes fijos para ese mes. Cada anulación debe ser al menos su mínimo global y sustituye al mínimo solo ese mes.\n\nCada mes, el objetivo de beneficio neto de ese mes se reparte entre los productos según su porcentaje de ventas, dando un número de ventas requeridas por producto:\n\n  required_sales = ceil(parte * (objetivo_mensual + costes_fijos) / beneficio_neto_por_unidad)\n\nEl deslizador de costes fijos añade un coste fijo mensual (unidades de moneda) restado del beneficio neto del mes, por lo que los productos deben cubrir tanto el objetivo como la carga fija. El total anual es la SUMA de los 12 resultados mensuales, por lo que el objetivo anual de beneficio neto es solo una referencia.\n\n## Productos / servicios paralelos\nEl deslizador \"parallel\" indica cuántos productos pueden producirse o servicios entregarse a la vez. Junto con las horas de jornada define la CAPACIDAD de producción mensual en minutos:\n\n  capacity_minutes = horas_jornada * 22 jornadas * 60 * paralelo\n\nSi los minutos de producción requeridos superan la capacidad, las ventas se reducen para encajar (el objetivo no se puede cumplir ese mes). Las horas de jornada y los productos en paralelo se fijan por mes (cada uno al menos su mínimo global); el máximo del deslizador de paralelo de un mes se recalcula a partir de la carga de ese mes en cada cambio.\n\n## Horas de jornada\nCuántas horas al día opera el negocio (1..24, por defecto 8). Interviene en la fórmula de capacidad y en la figura de \"jornadas\" mostrada en los resultados:\n\n  workdays = horas_requeridas / (horas_jornada * paralelo)\n\nEl \"mín. horas de jornada\" de Año completo fija el suelo; cada mes lo anula (al menos el mínimo). El Gráfico muestra siempre el año completo. Sobre las barras de cada mes un ✔ verde marca los meses cuyo beneficio neto alcanzado cumple el objetivo del mes; un ✖ rojo marca los que no. Una flecha hacia abajo sobre las barras del mes seleccionado lo resalta (sin flecha para Año completo).\n\n## Distribución de ventas mensual / anual %\nEl objetivo de cada mes se reparte entre los productos usando porcentajes. Cada columna de mes siempre suma exactamente 100%. Los deslizadores de porcentaje avanzan en pasos de 0,1% (el valor se muestra con un decimal, p. ej. 50,0%).\n\n  - Un período de mes: cada producto muestra un deslizador de % mensual para ese mes. Al editarlo se fija el % de ese producto y el resto se redistribuye EQUITATIVAMENTE entre los demás productos no bloqueados de ese mes.\n  - Período de Año completo: cada producto muestra un deslizador de % anual (la media de sus 12 valores mensuales). Al editarlo se propaga el objetivo a cada mes en que el producto no esté bloqueado por mes, redistribuyendo dentro de cada mes.\n\nEl gráfico dibuja 12 columnas mensuales independientes, por lo que la mezcla puede variar por mes (demanda estacional). El total anual es la suma de los 12 meses.\n\n## Bloqueos\nLos bloqueos congelan el porcentaje de un producto para excluirlo de la redistribución.\n\n  - Bloqueo anual (período de Año completo, Espacio en un deslizador anual): congela el producto en TODOS los 12 meses. Las casillas mensuales se muestran marcadas y en gris.\n  - Bloqueo mensual (un período de mes, Espacio en un deslizador mensual): congela el producto solo para ese mes (se desactiva si el producto está bloqueado anualmente).\n\nLos productos bloqueados mantienen su parte fija del pastel del 100%; el porcentaje restante se reparte entre los productos desbloqueados.\n\n## Exportación y estado\nPulsa Ctrl+E para exportar la simulación actual:\n\n  - Un <producto>.simulation_results.txt por producto (estadísticas + 12 filas mensuales + fila anual + jornada/paralelo).\n  - Un totals.simulation_results.txt agregando todos los productos.\n  - Un archivo simulation_state.txt (texto plano, editable) que guarda porcentajes, bloqueos y ajustes.\n\nAl reabrir la app se restaura la distribución guardada. Si se añadieron o quitaron productos desde el guardado, los porcentajes de cada mes se renormalizan para sumar 100%.\n\n## Totales de la barra lateral\nLa parte inferior de la barra lateral muestra los totales alcanzables (limitados por capacidad), que siempre coinciden con el gráfico. El diseño depende del período seleccionado:\n\n  - Año completo: columna izquierda = totales Anuales; columna derecha = Ref. anual.\n  - Un mes: columna izquierda = totales Mensuales (+ una línea de cumplimiento del objetivo); columna derecha = totales Anuales + Ref. anual.\n\nCada bloque de período (Mensual / Anual) muestra cuatro filas:\n  - ventas — unidades totales vendidas (tras el limitado por capacidad).\n  - minutos — minutos de producción alcanzados (unidades limitadas x tiempo de producción del producto).\n  - horas — minutos / 60.\n  - jornadas — horas / (horas_jornada x paralelo). Las jornadas anuales suman cada mes usando su propia anulación de horas de jornada / paralelo.\n\nPara un mes seleccionado, una línea extra al final del bloque Mensual muestra si se alcanzó el objetivo de beneficio neto del mes: marca verde si el beneficio neto alcanzado del mes >= el objetivo del mes, aspa roja en caso contrario, seguido del valor del objetivo.\n\nEl bloque Ref. anual compara la suma de los 12 objetivos mensuales de beneficio neto (cada uno incluyendo los costes fijos de ese mes) con el objetivo anual de beneficio neto:\n  - 12x mes — suma de los 12 objetivos mensuales de beneficio neto (la anulación de cada mes, si no el mín. beneficio neto mensual global) más los costes fijos de cada mes.\n  - marca / aspa + objetivo — marca verde si esa suma cumple el objetivo anual de beneficio neto, aspa roja en caso contrario, seguido del valor objetivo. El objetivo anual de beneficio neto es solo una referencia; el total anual es la suma de los 12 resultados mensuales.\n\n## Teclas\n  Tab          cambiar sub-pestaña Productos <-> Gráfico\n  Shift+Tab    alternar barra lateral <-> área principal (o también funciona en TTYs raw donde Shift+Tab = Tab)\n  [ / ]        mover la selección de período de nivel superior (Año completo, Ene..Dic)\n  Up / Down    desplazar área principal o navegar deslizadores\n  Left / Right ajustar el deslizador en foco\n  Space        alternar el bloqueo del deslizador de producto en foco\n  Ctrl+E       exportar simulación + guardar estado\n  Ctrl+H       abrir / cerrar esta ayuda\n  q / Esc      salir (cierra la ayuda si está abierta)",
        "## 产品定义（.txt 文件）\n每个产品是业务文件夹中的一个纯文本文件。第一行定义产品；此后每个以 \"- \" 开头的行是一个成本项。\n\n  + <名称> : <售价> <货币> : <生产时间> <单位>\n    - <成本价> <货币> <描述>\n    - <成本价> <货币> <描述>\n\n  示例：\n  + Beer : 2.7 USD : 0.2 mins\n    - 0.27 USD labor\n    - 0.32 USD beer\n    - 0.10 USD cleaning\n\n  - 货币：任意 3 位 ISO 4217 代码（USD、EUR、GBP、JPY、MXN、CNY 等）。\n  - 生产时间单位：\"mins\" 或 \"hours\"。\n  - 净利润（售价 - 总成本）为零或负的产品会被跳过。\n  - 匹配 *.simulation_results.txt 的文件以及 simulation_state.txt 会被加载器忽略。\n\n## 月度与年度净利润目标\n模拟器以净利润（收入减成本）为目标，而非收入。顶层周期标签选择“全年”或某个月份（1 月..12 月）；侧栏会相应变化：\n\n  - 全年：四个全局滑块 — 最小工作日小时（默认 8）、最小并行产品（默认 1）、最小月度净利润（默认 500）和年度净利润目标（默认 500，显示在 12 x 月度合计旁的参考）。\n  - 某个月：四个覆盖滑块 — 该月的工作日小时、并行产品、净利润和固定成本。每个覆盖必须至少为其全局最小值，且仅在该月替换最小值。\n\n每月，该月的净利润目标按各产品的销售百分比分摊，得到每个产品所需的销售数量：\n\n  required_sales = ceil(份额 * (月度目标 + 固定成本) / 单位净利润)\n\n固定成本滑块添加每月固定成本（货币单位），从该月净利润中扣除，因此产品需同时覆盖目标和固定负担。年度总额是 12 个月结果的求和，因此年度净利润目标仅作参考。\n\n## 并行产品 / 服务\n\"parallel\" 滑块表示可同时生产或交付的产品/服务数量。它与每日工时一起定义以分钟为单位的月度产能：\n\n  capacity_minutes = 每日工时 * 22 工作日 * 60 * 并行数\n\n若所需生产分钟数超过产能，销量会按比例缩减以适应（该月无法完全达成目标）。工作日小时和并行产品按月设置（每个至少其全局最小值）；某月的并行滑块最大值会根据该月负载在每次更改时重新计算。\n\n## 每日工时\n业务每天运营的小时数（1..24，默认 8）。它参与上方的产能公式，以及结果中显示的“工作日”数值：\n\n  workdays = 所需小时 / (每日工时 * 并行数)\n\n全年的“最小工作日小时”设定下限；每个月可覆盖它（至少为最小值）。图表始终显示全年。每月柱子上方绿色 ✔ 标记达成该月目标的月份，红色 ✖ 标记未达成的月份。所选月份的柱子上方会有一个向下箭头加以高亮（全年时无箭头）。\n\n## 月度 / 年度销售分布 %\n每月目标通过百分比在产品之间分配。每个月份列始终精确求和为 100%。百分比滑块以 0.1% 为步进（值显示一位小数，如 50.0%）。\n\n  - 月份周期：每个产品显示该月的月度 % 滑块。编辑它会设定该产品的 %，并将余数在当月其他未锁定的产品之间平均重新分配。\n  - 全年周期：每个产品显示年度 % 滑块（其 12 个月度值的均值）。编辑它会将目标传播到该产品未被月锁定的每个月，并在每个月内重新分配。\n\n图表绘制 12 个独立的月份列，因此各月组合可不同（季节性需求）。年度总额是 12 个月之和。\n\n## 锁定\n锁定会冻结某产品的百分比，使其不参与重新分配。\n\n  - 年度锁定（全年周期，在年度滑块上按 Space）：在全部 12 个月冻结该产品。月份复选框显示为已勾选并变灰。\n  - 月度锁定（月份周期，在月度滑块上按 Space）：仅冻结该月中该产品（若产品已被年度锁定则禁用）。\n\n被锁定的产品保持其在 100% 饼图中的固定份额；剩余百分比在未锁定产品之间分配。\n\n## 导出与状态\n按 Ctrl+E 导出当前模拟：\n\n  - 每个产品一个 <产品>.simulation_results.txt（统计 + 12 行月度 + 年度行 + 工时/并行）。\n  - 一个汇总全部产品的 totals.simulation_results.txt。\n  - 一个保存百分比、锁定和设置的 simulation_state.txt 文件（纯文本，可编辑）。\n\n重新打开应用会恢复已保存的分布。若自上次保存后产品有增减，每个月的百分比会被重新归一化为求和 100%。\n\n## 侧栏合计\n侧栏底部显示可达成的（受产能限制的）合计，始终与图表一致。布局取决于所选周期：\n\n  - 全年：左列 = 年度合计；右列 = 年度参考。\n  - 某个月：左列 = 月度合计（+ 目标达成行）；右列 = 年度合计 + 年度参考。\n\n每个周期块（月度 / 年度）显示四行：\n  - sales — 售出总件数（产能限制后）。\n  - minutes — 实际生产分钟数（限制后件数 × 产品生产时间）。\n  - hours — 分钟 / 60。\n  - workdays — 小时 / (每日工时 × 并行数)。年度工作日按每个月各自的每日工时 / 并行覆盖求和。\n\n对于所选月份，月度块末尾的额外行显示该月净利润目标是否达成：若该月达成净利润 ≥ 该月目标则显示绿色 ✔，否则显示红色 ✖，后跟目标值。\n\n年度参考块将 12 个月净利润目标之和（各月均含该月固定成本）与年度净利润目标比较：\n  - 12x 月 — 12 个月净利润目标之和（各月覆盖值，否则为全局最小月度净利润）加上各月的固定成本。\n  - ✔ / ✖ + goal — 若该总和达到年度净利润目标则显示绿色 ✔，否则红色 ✖，后跟目标值。年度净利润目标仅作参考；年度总额是 12 个月结果之和。\n\n## 按键\n  Tab          切换 Products <-> Graph 子标签\n  Shift+Tab    切换侧栏 <-> 主区域（在 Shift+Tab = Tab 的原始 TTY 上也可用 o 键）\n  [ / ]        移动顶层周期选择（全年、1 月..12 月）\n  Up / Down    滚动主区域或导航侧栏滑块\n  Left / Right 调整聚焦滑块\n  Space        切换聚焦产品滑块的锁定\n  Ctrl+E       导出模拟 + 保存状态\n  Ctrl+H       打开 / 关闭本帮助\n  q / Esc      退出（若帮助已打开则先关闭帮助）",
        "## Produktdefinition (.txt-Dateien)\nJedes Produkt ist eine Klartextdatei im Geschäftordner. Die erste Zeile definiert das Produkt; jede weitere Zeile, die mit „- \" beginnt, ist ein Kostenpunkt.\n\n  + <Name> : <Verkaufspreis> <Währung> : <Produktionszeit> <Einheit>\n    - <Kostenpreis> <Währung> <Beschreibung>\n    - <Kostenpreis> <Währung> <Beschreibung>\n\n  Beispiel:\n  + Beer : 2.7 USD : 0.2 mins\n    - 0.27 USD labor\n    - 0.32 USD beer\n    - 0.10 USD cleaning\n\n  - Währung: jeder 3-stellige ISO-4217-Code (USD, EUR, GBP, JPY, MXN, CNY, ...).\n  - Einheiten der Produktionszeit: „mins\" oder „hours\".\n  - Produkte mit null oder negativem Nettogewinn (Preis - Gesamtkosten) werden übersprungen.\n  - Dateien mit *.simulation_results.txt und simulation_state.txt werden vom Loader ignoriert.\n\n## Monats- & Jahres-Nettogewinnziele\nDer Simulator verfolgt ein NETTOGEWINN-Ziel (Einnahmen minus Kosten), nicht Umsatz. Die obersten Perioden-Tabs wählen Gesamtes Jahr oder einen einzelnen Monat (Jan..Dez); die Sidebar ändert sich entsprechend:\n\n  - Gesamtes Jahr: vier globale Regler — Min. Arbeitsstunden (Standard 8), Min. Parallelprodukte (Standard 1), Min. monatlicher Nettogewinn (Standard 500) und Ziel-Jahresnettogewinn (Standard 500, eine Referenz neben der 12 x Monats-Summe).\n  - Ein Monat: vier Override-Regler — Arbeitsstunden, Parallelprodukte, Nettogewinn und Fixkosten für diesen Monat. Jeder Override muss mindestens seinem globalen Minimum entsprechen und ersetzt das Minimum nur in diesem Monat.\n\nJeden Monat wird das Nettogewinnziel dieses Monats nach den Verkaufs-Prozenten der Produkte aufgeteilt; ergibt die erforderliche Stückzahl je Produkt:\n\n  required_sales = ceil(Anteil * (Monatsziel + Fixkosten) / Nettogewinn_pro_Einheit)\n\nDer Fixkosten-Regler addiert monatliche Fixkosten (Währungseinheiten), die vom Nettogewinn des Monats abgezogen werden; die Produkte müssen also sowohl Ziel als auch Fixkosten decken. Die Jahressumme ist die SUMME der 12 Monatswerte, das Ziel-Jahresnettogewinn ist also nur ein Referenzwert.\n\n## Parallele Produkte / Dienste\nDer Regler „parallel\" gibt an, wie viele Produkte gleichzeitig hergestellt bzw. Dienste geliefert werden können. Zusammen mit den Arbeitsstunden ergibt sich die monatliche Produktions-KAPAZITÄT in Minuten:\n\n  capacity_minutes = arbeitsstunden * 22 Arbeitstage * 60 * parallel\n\nÜbersteigen die erforderlichen Produktionsminuten die Kapazität, werden die Verkäufe passend herunterskaliert (das Ziel ist in diesem Monat nicht vollständig erreichbar). Arbeitsstunden und Parallelprodukte werden pro Monat gesetzt (jeweils mindestens ihr globales Minimum); das Maximum des Parallel-Reglers eines Monats wird bei jeder Änderung aus der Last dieses Monats neu berechnet.\n\n## Arbeitsstunden\nWie viele Stunden pro Tag das Geschäft arbeitet (1..24, Standard 8). Fließt in die Kapazitätsformel ein und in die „Arbeitstage\"-Angabe der Ergebnisse:\n\n  workdays = erforderliche_Stunden / (arbeitsstunden * parallel)\n\nDie „Min. Arbeitsstunden\" von Gesamtes Jahr setzen den Boden; jeder Monat überschreibt ihn (mindestens das Minimum). Das Diagramm zeigt immer das gesamte Jahr. Über den Balken jedes Monats zeigt ein grüner ✔ Monate, deren erreichter Nettogewinn das Monatsziel erfüllt; ein rotes ✖ markiert Monate, die dahinter zurückbleiben. Ein Pfeil nach unten über den Balken des gewählten Monats hebt ihn hervor (kein Pfeil bei Gesamtes Jahr).\n\n## Monats- / Jahres-Verkaufsverteilung %\nDas Monatsziel wird über Prozentangaben unter die Produkte verteilt. Jede Monatsspalte ergibt immer exakt 100%. Prozent-Regler bewegen sich in 0,1%-Schritten (der Wert wird mit einer Nachkommastelle angezeigt, z. B. 50,0%).\n\n  - Eine Monatsperiode: jedes Produkt zeigt einen Monats-%-Regler für diesen Monat. Bearbeiten setzt den % des Produkts und verteilt den Rest GLEICHMÄSSIG unter den anderen nicht gesperrten Produkten dieses Monats.\n  - Gesamtes-Jahr-Periode: jedes Produkt zeigt einen Jahres-%-Regler (den Mittel seiner 12 Monatswerte). Bearbeiten propagiert den Zielwert in jeden Monat, in dem das Produkt nicht monatsgesperrt ist, und verteilt innerhalb jedes Monats neu.\n\nDas Diagramm zeichnet 12 separate Monatsspalten, sodass die Zusammensetzung je Monat variieren kann (saisonale Nachfrage). Die Jahressumme ist die Summe der 12 Monate.\n\n## Sperren\nSperren frieren den Prozentsatz eines Produkts ein und nehmen es von der Neuverteilung aus.\n\n  - Jahressperre (Gesamtes-Jahr-Periode, Leertaste auf Jahresregler): friert das Produkt in ALLEN 12 Monaten ein. Monats-Kästchen erscheinen markiert und ausgegraut.\n  - Monatssperre (eine Monatsperiode, Leertaste auf Monatsregler): friert das Produkt nur in diesem Monat (deaktiviert, falls das Produkt jahresgesperrt ist).\n\nGesperrte Produkte behalten ihren festen Anteil am 100%-Kuchen; der restliche Prozentsatz wird unter den nicht gesperrten Produkten aufgeteilt.\n\n## Export & Status\nMit Ctrl+E den aktuellen Stand exportieren:\n\n  - Pro Produkt eine <produkt>.simulation_results.txt (Statistik + 12 Monatszeilen + Jahreszeile + Arbeitstag/Parallel).\n  - Eine totals.simulation_results.txt über alle Produkte.\n  - Eine simulation_state.txt-Datei (Klartext, editierbar), die Prozente, Sperren und Einstellungen speichert.\n\nBeim erneuten Öffnen wird die gespeicherte Verteilung wiederhergestellt. Wurden Produkte hinzugefügt oder entfernt, werden die Prozente je Monat neu normalisiert, sodass sie 100% ergeben.\n\n## Sidebar-Gesamtwerte\nUnten in der Sidebar werden erreichbare (kapazitätsbegrenzte) Gesamtwerte angezeigt, die immer mit dem Diagramm übereinstimmen. Das Layout hängt vom gewählten Zeitraum ab:\n\n  - Gesamtes Jahr: linke Spalte = Jährliche Gesamtwerte; rechte Spalte = Jahresref.\n  - Ein Monat: linke Spalte = Monatliche Gesamtwerte (+ eine Ziel-Ereichungszeile); rechte Spalte = Jährliche Gesamtwerte + Jahresref.\n\nJeder Periodenblock (Monatlich / Jährlich) zeigt vier Zeilen:\n  - Verkäufe — verkaufte Gesamteinheiten (nach Kapazitätsbegrenzung).\n  - Minuten — erreichte Produktionsminuten (begrenzte Einheiten × Produktionszeit des Produkts).\n  - Std. — Minuten / 60.\n  - Arbeitstage — Std. / (Arbeitsstunden × parallel). Die jährlichen Arbeitstage summieren jeden Monat mit seinem eigenen Arbeitsstunden-/Parallel-Override.\n\nFür einen gewählten Monat zeigt eine zusätzliche Zeile am Ende des Monatlich-Blocks, ob das Nettogewinnziel des Monats erreicht wurde: grüner Haken, wenn der erreichte Nettogewinn des Monats ≥ das Monatsziel ist, sonst rotes Kreuz, gefolgt vom Zielwert.\n\nDer Jahresref.-Block vergleicht die Summe der 12 monatlichen Nettogewinnziele (jeweils einschließlich der Fixkosten dieses Monats) mit dem Ziel-Jahresnettogewinn:\n  - 12x Mo — Summe der 12 monatlichen Nettogewinnziele (jeweils der Monats-Override, sonst das globale Min. monatlicher Nettogewinn) zuzüglich der Fixkosten jedes Monats.\n  - Haken / Kreuz + Ziel — grüner Haken, wenn die Summe das Ziel-Jahresnettogewinn erreicht, sonst rotes Kreuz, gefolgt vom Zielwert. Das Ziel-Jahresnettogewinn ist nur ein Referenzwert; die Jahressumme ist die Summe der 12 Monatswerte.\n\n## Tasten\n  Tab          Products <-> Graph Unter-Tab wechseln\n  Shift+Tab    Sidebar <-> Hauptbereich wechseln (o funktioniert auch auf Raw-TTYs, wo Shift+Tab = Tab)\n  [ / ]        die oberste Periodenauswahl verschieben (Gesamtes Jahr, Jan..Dez)\n  Up / Down    Hauptbereich scrollen oder Sidebar-Regler navigieren\n  Left / Right fokussierten Regler anpassen\n  Space        Sperre des fokussierten Produktreglers umschalten\n  Ctrl+E       Simulation exportieren + Status speichern\n  Ctrl+H       diese Hilfe öffnen / schließen\n  q / Esc      beenden (Hilfe schließen, wenn offen)",
        "## Определение продукта (файлы .txt)\nКаждый продукт — текстовый файл в папке бизнеса. Первая строка задаёт продукт; каждая следующая строка, начинающаяся с «- », — это статья затрат.\n\n  + <название> : <цена_продажи> <валюта> : <время_производства> <единица>\n    - <цена_затрат> <валюта> <описание>\n    - <цена_затрат> <валюта> <описание>\n\n  Пример:\n  + Beer : 2.7 USD : 0.2 mins\n    - 0.27 USD labor\n    - 0.32 USD beer\n    - 0.10 USD cleaning\n\n  - Валюта: любой 3-буквенный код ISO 4217 (USD, EUR, GBP, JPY, MXN, CNY, ...).\n  - Единицы времени производства: «mins» или «hours».\n  - Продукты с нулевой или отрицательной чистой прибылью (цена - итог затрат) пропускаются.\n  - Файлы *.simulation_results.txt и simulation_state.txt игнорируются загрузчиком.\n\n## Цели по месячной и годовой чистой прибыли\nСимулятор ориентируется на цель по ЧИСТОЙ ПРИБЫЛИ (доход минус затраты), а не по выручке. Верхние вкладки периода выбирают Весь год или один месяц (Янв..Дек); боковая панель меняется соответственно:\n\n  - Весь год: четыре глобальных ползунка — мин. часы рабочего дня (по умолчанию 8), мин. параллельные продукты (по умолчанию 1), мин. месячная чистая прибыль (по умолчанию 500) и цель годовой чистой прибыли (по умолчанию 500, ориентир рядом с суммой 12 x месячных).\n  - Месяц: четыре ползунка-переопределения — часы рабочего дня, параллельные продукты, чистая прибыль и фикс. затраты для этого месяца. Каждое переопределение должно быть не меньше его глобального минимума и заменяет минимум только в этом месяце.\n\nКаждый месяц месячная цель распределяется между продуктами по их процентам продаж, давая требуемое число продаж по каждому продукту:\n\n  required_sales = ceil(доля * (месячная_цель + фикс._затраты) / чистая_прибыль_за_единицу)\n\nПолзунок фикс. затрат добавляет месячные фиксированные затраты (валютные единицы), вычитаемые из чистой прибыли месяца, поэтому продукты должны покрыть и цель, и фиксированную нагрузку. Годовой итог — это СУММА 12 месячных результатов, поэтому цель годовой чистой прибыли лишь ориентир.\n\n## Параллельные продукты / услуги\nПолзунок «parallel» — сколько продуктов можно производить или услуг оказывать одновременно. Вместе с часами рабочего дня он задаёт месячную ПРОИЗВОДСТВЕННУЮ МОЩНОСТЬ в минутах:\n\n  capacity_minutes = часы_рабочего_дня * 22 рабочих_дня * 60 * parallel\n\nЕсли требуемые минуты производства превышают мощность, продажи пропорционально уменьшаются (в этом месяце цель недостижима полностью). Часы рабочего дня и параллельные продукты задаются по месяцам (каждый не меньше своего глобального минимума); максимум ползунка parallel месяца пересчитывается из нагрузки этого месяца при каждом изменении.\n\n## Часы рабочего дня\nСколько часов в день работает бизнес (1..24, по умолчанию 8). Используется в формуле мощности выше и в показателе «рабочие дни» в результатах:\n\n  workdays = требуемые_часы / (часы_рабочего_дня * parallel)\n\n«Мин. часы рабочего дня» Весь год задаёт нижнюю границу; каждый месяц переопределяет её (не меньше минимума). График всегда показывает весь год. Над столбцами каждого месяца зелёная ✔ отмечает месяцы, достигшие месячной цели по чистой прибыли; красная ✖ — месяцы, не достигшие её. Стрелка вниз над столбцами выбранного месяца выделяет его (без стрелки для Весь год).\n\n## Месячное / годовое распределение продаж %\nЦель каждого месяца делится между продуктами через проценты. Каждый столбец месяца всегда даёт в сумме ровно 100%. Процентные ползунки движутся с шагом 0,1% (значение показывается с одним знаком после запятой, напр. 50,0%).\n\n  - Период месяца: у каждого продукта ползунок месячного % для этого месяца. Изменение задаёт % продукта и перераспределяет остаток ПОРОВНУ между остальными незаблокированными продуктами этого месяца.\n  - Период Весь год: у каждого продукта ползунок годового % (среднее его 12 месячных значений). Изменение распространяет целевое значение на каждый месяц, где продукт не заблокирован по месяцу, с перераспределением внутри каждого месяца.\n\nДиаграмма строит 12 отдельных месячных столбцов, поэтому состав может меняться по месяцам (сезонный спрос). Годовой итог — сумма 12 месяцев.\n\n## Блокировки\nБлокировки замораживают процент продукта, исключая его из перераспределения.\n\n  - Годовая блокировка (период Весь год, Space на годовом ползунке): замораживает продукт во ВСЕХ 12 месяцах. Флажки месяцев отображаются отмеченными и серыми.\n  - Месячная блокировка (период месяца, Space на месячном ползунке): замораживает продукт только в этом месяце (отключена, если продукт заблокирован по году).\n\nЗаблокированные продукты сохраняют фиксированную долю 100%-ного пирога; оставшийся процент делится между незаблокированными продуктами.\n\n## Экспорт и состояние\nНажмите Ctrl+E для экспорта текущей симуляции:\n\n  - По одному <продукт>.simulation_results.txt на продукт (статистика + 12 месячных строк + годовая строка + рабочий день/parallel).\n  - Файл totals.simulation_results.txt, объединяющий все продукты.\n  - Файл simulation_state.txt (простой текст, редактируемый), сохраняющий проценты, блокировки и настройки.\n\nПри повторном открытии восстанавливается сохранённое распределение. Если продукты были добавлены или удалены, проценты каждого месяца перенормируются к сумме 100%.\n\n## Итоги боковой панели\nВнизу боковой панели показываются достижимые (ограниченные мощностью) итоги, всегда совпадающие с графиком. Макет зависит от выбранного периода:\n\n  - Весь год: левый столбец = Годовые итоги; правый = Годовой ориентир.\n  - Месяц: левый столбец = Месячные итоги (+ строка достижения цели); правый = Годовые итоги + Годовой ориентир.\n\nКаждый блок периода (Месячно / Годово) показывает четыре строки:\n  - продажи — всего продано единиц (после ограничения мощностью).\n  - минуты — достигнутые минуты производства (ограниченные единицы × время производства продукта).\n  - часы — минуты / 60.\n  - раб. дни — часы / (часы_рабочего_дня × параллельность). Годовые рабочие дни суммируют каждый месяц с его собственным значением часов/параллельности.\n\nДля выбранного месяца дополнительная строка в конце блока «Месячно» показывает, достигнута ли месячная цель по чистой прибыли: зелёная галка, если достигнутая чистая прибыль месяца ≥ цель месяца, иначе красный крест, за которым следует значение цели.\n\nБлок «Годовой ориентир» сравнивает сумму 12 месячных целей по чистой прибыли (каждая с учётом фикс. затрат этого месяца) с целью годовой чистой прибыли:\n  - 12x мес — сумма 12 месячных целей по чистой прибыли (переопределение месяца, иначе глобальный мин. месячная чистая прибыль) плюс фикс. затраты каждого месяца.\n  - галка / крест + цель — зелёная галка, если сумма достигает цели годовой чистой прибыли, иначе красный крест, за которым следует целевое значение. Цель годовой чистой прибыли — лишь ориентир; годовой итог — сумма 12 месячных результатов.\n\n## Клавиши\n  Tab          переключить под-вкладку Products <-> Graph\n  Shift+Tab    переключить боковую панель <-> главную область (o также работает на raw-TTY, где Shift+Tab = Tab)\n  [ / ]        переместить выбор периода верхнего уровня (Весь год, Янв..Дек)\n  Up / Down    прокрутка главной области или навигация по ползункам\n  Left / Right настроить активный ползунок\n  Space        переключить блокировку активного ползунка продукта\n  Ctrl+E       экспорт симуляции + сохранение состояния\n  Ctrl+H       открыть / закрыть эту справку\n  q / Esc      выход (закрыть справку, если она открыта)",
        "## Définition du produit (fichiers .txt)\nChaque produit est un fichier texte brut dans le dossier du commerce. La première ligne définit le produit ; chaque ligne suivante commençant par « - » est un coût.\n\n  + <nom> : <prix_vente> <monnaie> : <temps_production> <unité>\n    - <prix_coût> <monnaie> <description>\n    - <prix_coût> <monnaie> <description>\n\n  Exemple :\n  + Beer : 2.7 USD : 0.2 mins\n    - 0.27 USD labor\n    - 0.32 USD beer\n    - 0.10 USD cleaning\n\n  - Monnaie : tout code ISO 4217 à 3 lettres (USD, EUR, GBP, JPY, MXN, CNY, ...).\n  - Unités de temps de production : « mins » ou « hours ».\n  - Les produits dont le profit net (prix - coût total) est nul ou négatif sont ignorés.\n  - Les fichiers *.simulation_results.txt et simulation_state.txt sont ignorés par le chargeur.\n\n## Objectifs de profit net mensuel et annuel\nLe simulateur vise un objectif de PROFIT NET (revenus moins coûts), pas de chiffre d'affaires. Les onglets de période de niveau supérieur sélectionnent Année complète ou un mois unique (janv.~déc.) ; la barre latérale change en conséquence :\n\n  - Année complète : quatre curseurs globaux — min. heures de travail (8 par défaut), min. produits parallèles (1 par défaut), min. profit net mensuel (500 par défaut) et objectif annuel de profit net (500 par défaut, une référence affichée à côté de la somme 12 x mensuelle).\n  - Un mois : quatre curseurs de surcharge — heures de travail, produits parallèles, profit net et coûts fixes pour ce mois. Chaque surcharge doit être au moins égale à son minimum global et remplace le minimum seulement pour ce mois.\n\nChaque mois, l'objectif de profit net de ce mois est réparti entre les produits selon leur part de ventes en %, donnant un nombre de ventes requises par produit :\n\n  required_sales = ceil(part * (objectif_mensuel + coûts_fixes) / profit_net_par_unité)\n\nLe curseur coûts fixes ajoute un coût fixe mensuel (unités de monnaie) soustrait du profit net du mois ; les produits doivent donc couvrir à la fois l'objectif et la charge fixe. Le total annuel est la SOMME des 12 résultats mensuels, l'objectif annuel de profit net n'est donc qu'une référence.\n\n## Produits / services parallèles\nLe curseur « parallel » indique combien de produits peuvent être produits ou services livrés simultanément. Avec les heures de journée, il définit la CAPACITÉ de production mensuelle en minutes :\n\n  capacity_minutes = heures_journée * 22 jours * 60 * parallel\n\nSi les minutes de production requises dépassent la capacité, les ventes sont réduites en proportion (l'objectif ne peut être pleinement atteint ce mois-là). Les heures de journée et les produits parallèles sont définis par mois (chacun au moins son minimum global) ; le maximum du curseur parallel d'un mois est recalculé à partir de la charge de ce mois à chaque modification.\n\n## Heures de journée\nNombre d'heures par jour pendant lesquelles le commerce fonctionne (1..24, 8 par défaut). Entre dans la formule de capacité ci-dessus et dans la valeur « journées » affichée dans les résultats :\n\n  workdays = heures_requises / (heures_journée * parallel)\n\nLe « min. heures de travail » d'Année complète fixe le plancher ; chaque mois le surcharge (au moins le minimum). Le graphique montre toujours l'année complète. Au-dessus des barres de chaque mois un ✔ vert marque les mois dont le profit net atteint l'objectif du mois ; un ✖ rouge marque ceux qui n'y parviennent pas. Une flèche vers le bas au-dessus des barres du mois sélectionné le met en évidence (pas de flèche pour Année complète).\n\n## Distribution des ventes mensuelle / annuelle %\nL'objectif de chaque mois est réparti entre les produits via des pourcentages. Chaque colonne de mois fait toujours exactement 100 % au total. Les curseurs de pourcentage avancent par pas de 0,1 % (la valeur est affichée avec une décimale, p. ex. 50,0 %).\n\n  - Une période de mois : chaque produit affiche un curseur de % mensuel pour ce mois. Le modifier fixe le % du produit et redistribue le reste ÉGALEMENT entre les autres produits non verrouillés de ce mois.\n  - Période Année complète : chaque produit affiche un curseur de % annuel (la moyenne de ses 12 valeurs mensuelles). Le modifier propage la cible à chaque mois où le produit n'est pas verrouillé par mois, en redistribuant dans chaque mois.\n\nLe graphique dessine 12 colonnes mensuelles distinctes, donc la répartition peut varier par mois (demande saisonnière). Le total annuel est la somme des 12 mois.\n\n## Verrous\nLes verrous figent le pourcentage d'un produit pour l'exclure de la redistribution.\n\n  - Verrou annuel (période Année complète, Espace sur un curseur annuel) : fige le produit sur TOUS les 12 mois. Les cases mensuelles apparaissent cochées et grisées.\n  - Verrou mensuel (une période de mois, Espace sur un curseur mensuel) : fige le produit seulement pour ce mois (désactivé si le produit est verrouillé annuellement).\n\nLes produits verrouillés gardent leur part fixe du camembert des 100 % ; le reste est réparti entre les produits non verrouillés.\n\n## Exportation et état\nAppuyez sur Ctrl+E pour exporter la simulation actuelle :\n\n  - Un <produit>.simulation_results.txt par produit (statistiques + 12 lignes mensuelles + ligne annuelle + journée/parallel).\n  - Un totals.simulation_results.txt agrégeant tous les produits.\n  - Un fichier simulation_state.txt (texte brut, éditable) sauvegardant les pourcentages, verrous et réglages.\n\nÀ la réouverture, la distribution sauvegardée est restaurée. Si des produits ont été ajoutés ou supprimés depuis la sauvegarde, les pourcentages de chaque mois sont renormalisés pour sommer à 100 %.\n\n## Totaux de la barre latérale\nLe bas de la barre latérale affiche les totaux atteignables (limités par la capacité), qui correspondent toujours au graphique. La disposition dépend de la période sélectionnée :\n\n  - Année complète : colonne gauche = Totaux annuels ; colonne droite = Réf. annuelle.\n  - Un mois : colonne gauche = Totaux mensuels (+ une ligne d'atteinte de l'objectif) ; colonne droite = Totaux annuels + Réf. annuelle.\n\nChaque bloc de période (Mensuel / Annuel) affiche quatre lignes :\n  - ventes — unités totales vendues (après limitation de capacité).\n  - minutes — minutes de production atteintes (unités limitées × temps de production du produit).\n  - heures — minutes / 60.\n  - jours trav. — heures / (heures_travail × parallèle). Les jours travaillés annuels somment chaque mois avec sa propre surcharge d'heures/parallèle.\n\nPour un mois sélectionné, une ligne supplémentaire à la fin du bloc Mensuel indique si l'objectif de profit net du mois a été atteint : coche verte si le profit net atteint du mois ≥ l'objectif du mois, croix rouge sinon, suivie de la valeur de l'objectif.\n\nLe bloc Réf. annuelle compare la somme des 12 objectifs mensuels de profit net (chacun incluant les coûts fixes de ce mois) à l'objectif annuel de profit net :\n  - 12x mois — somme des 12 objectifs mensuels de profit net (surcharge du mois, sinon le min. profit net mensuel global) plus les coûts fixes de chaque mois.\n  - coche / croix + objectif — coche verte si la somme atteint l'objectif annuel de profit net, croix rouge sinon, suivie de la valeur cible. L'objectif annuel de profit net n'est qu'une référence ; le total annuel est la somme des 12 résultats mensuels.\n\n## Touches\n  Tab          basculer le sous-onglet Products <-> Graph\n  Shift+Tab    basculer barre latérale <-> zone principale (o fonctionne aussi sur TTYs bruts où Shift+Tab = Tab)\n  [ / ]        déplacer la sélection de période de niveau supérieur (Année complète, janv.~déc.)\n  Up / Down    défiler la zone principale ou naviguer les curseurs\n  Left / Right ajuster le curseur actif\n  Space        basculer le verrou du curseur produit actif\n  Ctrl+E       exporter la simulation + sauver l'état\n  Ctrl+H       ouvrir / fermer cette aide\n  q / Esc      quitter (ferme l'aide si elle est ouverte)",
    ],
}
