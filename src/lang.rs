...
define_dict! {
    ...
    tui_slider_min_parallel: ["min. paralell products", "mín. productos en paralelo", "最小并行产品", "Min. Parallelprodukte", "мин. параллельные продукты", "min. produits parallèles"],
    ...
    tui_slider_month_parallel: ["paralell products", "productos en paralelo", "并行产品", "Parallelprodukte", "параллельные продукты", "produits parallèles"],
    ...
    tui_footer: [
        "Shift+Tab sub-tab   [/] switch period tab   \u{2191}/\u{2193} scroll/navigate   \u{2190}/\u{2192} adjust   Space lock   Ctrl+E export   Ctrl+H help   q quit",
        "Shift+Tab sub-pestaña   [/] cambiar pestaña periodo   \u{2191}/\u{2193} desplazar/navegar   \u{2190}/\u{2192} ajustar   Espacio bloquear   Ctrl+E exportar   Ctrl+H ayuda   q salir",
        "Shift+Tab 子标签   [/] 切换周期标签   \u{2191}/\u{2193} 滚动/导航   \u{2190}/\u{2192} 调整   空格 锁定   Ctrl+E 导出   Ctrl+H 帮助   q 退出",
        "Shift+Tab Unter-Tab   [/] Zeitraum-Tab wechseln   \u{2191}/\u{2193} scrollen/navigieren   \u{2190}/\u{2192} anpassen   Leertaste sperren   Ctrl+E Export   Ctrl+H Hilfe   q Beenden",
        "Shift+Tab под-вкладка   [/] сменить вкладку периода   \u{2191}/\u{2193} прокрутка/навигация   \u{2190}/\u{2192} настроить   Пробел блок.   Ctrl+E экспорт   Ctrl+H справка   q выход",
        "Shift+Tab sous-onglet   [/] changer d'onglet période   \u{2191}/\u{2193} défiler/naviguer   \u{2190}/\u{2192} ajuster   Espace verrouiller   Ctrl+E exporter   Ctrl+H aide   q quitter",
    ],
    tui_footer_status: [
        "{0}   |   Shift+Tab sub-tab   [/] switch period tab   \u{2191}/\u{2193} scroll/navigate   \u{2190}/\u{2192} adjust   Space lock   Ctrl+E export   Ctrl+H help   q quit",
        "{0}   |   Shift+Tab sub-pestaña   [/] cambiar pestaña periodo   \u{2191}/\u{2193} desplazar/navegar   \u{2190}/\u{2192} ajustar   Espacio bloquear   Ctrl+E exportar   Ctrl+H ayuda   q salir",
        "{0}   |   Shift+Tab 子标签   [/] 切换周期标签   \u{2191}/\u{2193} 滚动/导航   \u{2190}/\u{2192} 调整   空格 锁定   Ctrl+E 导出   Ctrl+H 帮助   q 退出",
        "{0}   |   Shift+Tab Unter-Tab   [/] Zeitraum-Tab wechseln   \u{2191}/\u{2193} scrollen/navigieren   \u{2190}/\u{2192} anpassen   Leertaste sperren   Ctrl+E Export   Ctrl+H Hilfe   q Beenden",
        "{0}   |   Shift+Tab под-вкладка   [/] сменить вкладку периода   \u{2191}/\u{2193} прокрутка/навигация   \u{2190}/\u{2192} настроить   Пробел блок.   Ctrl+E экспорт   Ctrl+H справка   q выход",
        "{0}   |   Shift+Tab sous-onglet   [/] changer d'onglet période   \u{2191}/\u{2193} défiler/naviguer   \u{2190}/\u{2192} ajuster   Espace verrouiller   Ctrl+E exporter   Ctrl+H aide   q quitter",
    ],
